...
<body>
		...
		<div class="row">
			<div class="head">
				<div class="head2">
					...
					<div id="SuperBox">
						<button type="button" class="Message">쪽지함</button>
					</div>
					<div id="searchBox">
	...
	<div class="replyBox">
		<ul>
			<li><strong>받는 사람 : </strong><input type="text" id="receiver"></li>
		</ul>

		<ul>
			<li><textarea id="replyView"></textarea></li>
		</ul>

		<ul>
			<li>
				<button id="replyAtReply">답장하기</button>
				<button id="cancel">취소</button>
			</li>
		</ul>
   ...
   <div class="indexMessagePopup">
      <ul>
         <li class="denied">해당 권한이 없습니다.</li>
      </ul>
      <ul>
